...
# first = set(randint(1, 100) 
#             for i in range(int(input('Укажите количество числел в первом множестве: '))))
# print(first)
# second = set(randint(1, 100) 
#              for i in range(int(input('Укажите количество чисел во втором множестве: '))))
# print(second)
...
import random
kust = int(input("Укажите количество кустов: "))
...
print(f"Максимальное число ягод за однин раз {result[-1]}")
